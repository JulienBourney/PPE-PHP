...
public class ButtonEditorEditer extends DefaultCellEditor {
    ...
    private String leContratTravailSelectionne;
    ...
    public Component getTableCellEditorComponent(JTable table, Object value,
        ...
        if (isSelected) {
            ...
            leContratTravailSelectionne = (String) table.getValueAt(row, 0);
        }
    ...
    public Object getCellEditorValue() {
        if (isPushed) {
            new ContratCessionConfirmerEdition(leContratTravailSelectionne).setVisible(true);
        }
        isPushed = false;
