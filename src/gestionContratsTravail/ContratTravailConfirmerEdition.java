 ...
 * @author gaellecastel
 */
public class ContratTravailConfirmerEdition extends javax.swing.JFrame {

    private int indiceDuContratTravailAEditer;
    private String leContratTravailSelectionne;

    DefaultListModel modele = new DefaultListModel();

    public ContratTravailConfirmerEdition(String leContratTravailSelectionne) {
        initComponents();

        //pour que toute l'application ne se ferme pas quand on clique sur la croix rouge
        this.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
        
        this.leContratTravailSelectionne = leContratTravailSelectionne;

        //chargement du contrat de Travail concernée
        txtNumero.setText(leContratTravailSelectionne);
    }
    ...
    private void initComponents() {
        ...
        lblTitre1.setText("Êtes vous de vouloir éditer ce contrat de travail ?");
    ...
    private void btnOuiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOuiActionPerformed
        //lancement de l'édition du PDF en fonction du type de contrat
        //recherche du contrat portant ce numéro
        for (int i=0 ; i<NezDamesSerialisation.lesContratsTravail.size() ; i++) {
            if (NezDamesSerialisation.lesContratsTravail.get(i).getNumContratTravail().compareTo(leContratTravailSelectionne)==0) {
                indiceDuContratTravailAEditer = i;
            }
        }
        new GenererPdfContratTravail(indiceDuContratTravailAEditer);
        
        //modification de l'état d'édition du contrat de production
        NezDamesSerialisation.lesContratsTravail.get(indiceDuContratTravailAEditer).setEdition(TRUE);
        
        //affichage de la confirmation
        JOptionPane.showMessageDialog(this, "Contrat de travail généré en PDF.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ContratTravailConfirmerEdition.class
