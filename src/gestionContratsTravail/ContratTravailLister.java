...
public class ContratTravailLister extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setSize(new java.awt.Dimension(631, 583));
    ...
    private void formWindowGainedFocus(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowGainedFocus
        ...
        monModelTableauContratTravail.setDataVector(null,
                new Object[]{"NumeroContratTravail", "NumeroContratCession", "Nom", "Rôle", "Détails", "Modifier", "Supprimer"});
        ...
        if (!NezDamesSerialisation.lesContratsTravail.isEmpty()) { //s'il y a des contrat de Travail
            ...
            for (int i = 0; i < NezDamesSerialisation.lesContratsTravail.size(); i++) {
                String numeroContratTravail = NezDamesSerialisation.lesContratsTravail.get(i).getNumContratTravail();
                String numeroContratCession = NezDamesSerialisation.lesContratsTravail.get(i).getLeContratCession().getNumeroContratCession();
                String nom = NezDamesSerialisation.lesContratsTravail.get(i).getlIntermittent().getNomIntermittent();
                String role = NezDamesSerialisation.lesContratsTravail.get(i).getRole();
                
                        
                monModelTableauContratTravail.addRow(new Object[]{numeroContratTravail, numeroContratCession, nom, role, "Détails", "Modifier", "Supprimer"});
            ...
            jTableListeContratsTravail.getColumn("NumeroContratTravail").setPreferredWidth(100);
            jTableListeContratsTravail.getColumn("NumeroContratCession").setPreferredWidth(200);
            jTableListeContratsTravail.getColumn("Nom").setPreferredWidth(110);
            jTableListeContratsTravail.getColumn("Rôle").setPreferredWidth(110);
        }   
