...
public class GenererPdfContratTravail {
  ...
  public GenererPdfContratTravail(int indiceDuContratCessionAEditer) {
    try {
      leContrat = NezDamesSerialisation.lesContratsTravail.get(indiceDuContratCessionAEditer);
      FILE = "ContratsTravail/ContratDeTravail-"+NezDamesSerialisation.lesContratsCession.get(indiceDuContratCessionAEditer).getNumeroContratCession()+".pdf";
  ...
  private static void ajoutContenu(Document document) throws DocumentException, BadElementException, IOException {
    ...
    subCatPart.add(new Paragraph("    Titre du Spectacle : "/*                       A REMPLIR                                 */,smallBold));
    subCatPart.add(new Paragraph("    Numéro d'objet : "/*                       A REMPLIR                                 */,smallBold));    
    //on saute une ligne
    subCatPart.add(new Paragraph(" "));
    ...
    for (Representation uneRepresentation : leContrat.getLesRepresentations()) {
        ...
        subCatPart.add(new Paragraph("   Durée du jeu  :"+ /*        A REMPLIR     */   " minutes "));
    }
