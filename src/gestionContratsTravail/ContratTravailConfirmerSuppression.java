 ...
 * @author gaellecastel
 */
public class ContratTravailConfirmerSuppression extends javax.swing.JFrame {

    private int indiceDuContratTravailASupprimer;

    DefaultListModel modele = new DefaultListModel();

    public ContratTravailConfirmerSuppression(int laLigneSelectionnee) {
        initComponents();

        //pour que toute l'application ne se ferme pas quand on clique sur la croix rouge
        this.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
        
        indiceDuContratTravailASupprimer = laLigneSelectionnee;

        //chargement du numero concernée
        txtNumero.setText(((ContratTravail) NezDamesSerialisation.lesContratsTravail.get(laLigneSelectionnee)).getNumContratTravail());
    }
    ...
    private void initComponents() {
        ...
        lblTitre1.setText("Êtes vous de vouloir supprimer ce contrat de travail ?");
        ...
        setSize(new java.awt.Dimension(485, 172));
    ...
    private void btnOuiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOuiActionPerformed
        ...
        NezDamesSerialisation.lesContratsTravail.remove(indiceDuContratTravailASupprimer);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ContratTravailConfirmerSuppression.class
