                                            ...
                                            if (txtNationalite.getText().compareTo("") == 0) {
                                                ...
                                                if (txtNumeroCongeSpectacle.getText().compareTo("") == 0) {
                                                    ...
                                                    if (txtNumeroSecuriteSociale.getText().compareTo("") == 0) {
                                                        ...
                                                        int lastLesIntermittents = NezDamesSerialisation.lesIntermittents.size()-1;
                                                        Intermittent lIntermittent = NezDamesSerialisation.lesIntermittents.get(lastLesIntermittents);
                                                              
                                                        Connexion a = new Connexion();
                                                        a.addUtilisateur(lIntermittent.getIdIntermittent(),txtMail.getText(),"0000");
                                                        this.dispose();
                                                    }
                                                }
                                            }
